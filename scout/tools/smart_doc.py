            ...
            if missing_user_fields:
                return {
                    ...
                    "agent_instruction": (
                        ...
                        "call ask_questions with ONE QUESTION PER FIELD, using the field "
                        "name below as that question's `id` VERBATIM (use "
                        '"input_type": "date" for any date). Do NOT merge two fields into '
                        "one question: an answer returned under an id like `contact_info` "
                        "matches no placeholder, so both fields stay blank and you are "
                        "asked for them again. Ask for ALL of them in ONE card. "
                        "Then call generate_document "
